...
![ScreenShot](./lastlogin.png)

Sample profile attribute contents (showing a successful login after 2 failed login attempts):

[{"date":"1542037181481","sharedState":{"authLevel":"0"},"status":"SUCCESS"},{"date":"1542037174162","sharedState":{"authLevel":"0"},"status":"FAILED"},{"date":"1542037087563","sharedState":{"authLevel":"0"},"status":"FAILED"}]
